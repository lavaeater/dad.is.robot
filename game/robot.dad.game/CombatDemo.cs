...
namespace robot.dad.game
{
    ...
    {
        public readonly List<Combattant> Protagonists = new List<Combattant> {
        ...
        public readonly List<Combattant> Antagonists = new List<Combattant>
        {
            new Monster("Snarfor", 30, 90, 10, 5, 10, "nygren", new List<CombatMove>()
            {
